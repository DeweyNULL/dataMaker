...
public class RandomDataUtils {
    ...
    public static final String className = "com.dewey.core.utils.RandomDataUtils";
     ...
     * @return 随机生成的日期类
     */
    public static String getRandamDate(String begin, String end ){
        Date date = null;
     ...
     * @return
     */
    public static String getEmail(String lMin,String lMax) {
        int length=getNum(Integer.valueOf(lMin),Integer.valueOf(lMax));
     ...
     * @return
     */
    public static String getEnumData(String colName ,String colConfig){
        List<String> enumList = EnumMapUtils.get(colName,colConfig);
        if(ListUtils.isNotEmpty(enumList)){
            Random r = new Random();
            return enumList.get(r.nextInt(enumList.size()));
        }
        return null;
    }

    public static String getRndBankNo(){

        return "112233112233112233";
    }
}
